...
if(menu_cursor == 1 && menuCooldown <= 0){
	if(keyboard_check_pressed(ds_map_find_value(global.keyboard_map, "Left")) || keyboard_check_pressed(vk_left) || keyboard_check_pressed(ord("A")) || gamepad_axis_value(0, gp_axislh) < -0.2){
	...
	else if(keyboard_check_pressed(ds_map_find_value(global.keyboard_map, "Right")) || keyboard_check_pressed(vk_right) || keyboard_check_pressed(ord("D")) || gamepad_axis_value(0, gp_axislh) > 0.2){
